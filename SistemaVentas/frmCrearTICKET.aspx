...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .bordegris { border: 3.5px solid #CA515C; }
        ...
        border-color:#CA515C;
        box-shadow: 0 1px 1px #CA515C inset, 0 0 8px #CA515C;
        outline: 0 none;
        }
        select option {
        color:#CA515C;
        ...
        select { color:#000000; }
        option { color:red; background-color:#ffffff; }
        option:hover { color:#CA515C; background-color:#ffffff; }
               ...
               <div class="card">
                  <div class="card-header p-2">
                        <i class="fa fa-shopping-cart" aria-hidden="true"></i> <a style="color: #CA515C;"><b>Registrar Nuevo Ticket Hacia el Área: </b></a> 
                          <abbr title="ENVIAR TICKET"><button id="btnTerminarGuardarTICKET" style="background-color:#CA515C; border:#b20000" class="btn-custom btn-primary btn-sm-custom float-right btn-danger"><i class="fa fa-print" aria-hidden="true"></i> Imprimir y Terminar Ticket</button></abbr>
                        <abbr title="GUARDAR"> <asp:Button id="Button3" ClientIDMode="Static" style="background-color:#CA515C; border:#b20000" class="btn-custom btn-primary btn-sm-custom btn-danger float-right invisibles" OnClick="btnTerminarGuardarTICKET_Click" Text="Guardar y Enviar Ticket" runat="server"/> </abbr>
                        <asp:DropDownList ID="ddlEmail"  style="background-color:#ffffff;border-color:#CA515C;box-shadow: 2px 2px 2px 2px" class="custom-select float-right" runat="server" CssClass="auto-style1" Height="30px" Width="304px">
                            <asp:ListItem Value="juan.quintero758@pascualbravo.edu.co"> David Quintero  </asp:ListItem>  
                            <asp:ListItem Value="jquintero@coorditanques.com"> juan david quintero </asp:ListItem>  
                        </asp:DropDownList>
                          <asp:hiddenfield id="Ticket" value="0" ClientIDMode="Static" runat="server"/>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="input-group input-group-sm mb-2">
                                  ...
                                  <select class="custom-select" style="background-color:#ffffff;border-color:#CA515C;box-shadow: 1px 1px 1px 1px" id="cboTICKETtipodocumento">
                                      ...
                                      <div class="row">
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              ...
                                              <select class="form-control form-control-sm model" style="background-color:#ffffff;border-color:#CA515C;box-shadow: 1px 1px 1px 1px" id="cboDATOStipodocumento" name="Rol">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              ...
                                              <input type="text" class="form-control form-control-sm model" id="txtDATOSdocumento" name="ASUNTO" autocomplete="off" value="-">
                                            </div>
                                          </div>
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              <label for="txtASUNTOAREAProveedor" class="col-form-label col-form-label-sm">Nombres: <span class="required">*</span></label>
                                              <input type="text" class="form-control form-control-sm model" id="txtDATOSnombres" name="ASUNTO" autocomplete="off" value="-">
                                                <br />
                                            </div>
                                          </div>
                                      </div>
                                          ...
                                          <div class="col-sm-8">
                                            <div class="form-group mb-0">
                                              <label for="txtASUNTOAREAProveedor" ><a style="color: #CA515C;" class="col-form-label col-form-label-sm"><b>Incidente/Reporte/Solicitud (Puntualizar modulos y/o error):</b></a>
                                                ...
                                                <textarea id="txtDATOSdireccion" name="DATOSdireccion" placeholder="Introduce tu requerimiento..." autocomplete="off" cols="50" class="offset-sm-0" maxlength="350"></textarea>
                                                    </div>
...
<%--                                                <br /><br /><br /><br />
                                                <asp:FileUpload ID="FileUpload1" runat="server" text="Select"/>
                                                <br /><br />
                                                <asp:Button ID="Button1" runat="server" Text="Up" OnClick="Button1_Click"/>
                                                <br />
                                                <asp:Label ID="Label1" runat="server" Text=""></asp:Label> --%>
                                                
                                               <label for="txtASUNTOAREAProveedor" class="col-form-label col-form-label-sm">Adjunto:</label>
                                               <input type="file" class="form-control form-control-sm model" id="txtDATOStelefono" name="ASUNTO" autocomplete="off"> 
